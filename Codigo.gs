// ════════════════════════════════════════════════════════════
//  GENERADOR ESTADO JUDICIAL — Codigo.gs (ADAPTADO PARA VERCEL)
//  Incluye doPost() para recibir llamadas desde frontend externo
// ════════════════════════════════════════════════════════════
...
// ── Sirve la página web (ya no se usa si el frontend está en Vercel) ──
function doGet(e) {
...
// ════════════════════════════════════════════════════════════
//  doPost — ENDPOINT PARA LLAMADAS DESDE VERCEL
//  El frontend envía un JSON con { action: '...', ...params }
//  y este endpoint enruta a la función correspondiente.
// ════════════════════════════════════════════════════════════
function doPost(e) {
  try {
